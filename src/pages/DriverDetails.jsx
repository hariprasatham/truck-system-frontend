      ...
      <Card className="shadow-sm p-4 mb-4">
        ...
        <Container>
          ...
          <Row>
            <InfoBox
              label="Yard Moves"
              value={driver?.yard_moves == true ? "Allowed" : "Not Allowed"}
            />
            <InfoBox label="Status" value={driver?.status} />
            <InfoBox
              label="Personal CMV"
              value={driver?.personal_cmv == true ? "Allowed" : "Not Allowed"}
            />
              ...
              <Accordion.Body>
                <Row>
                  ...
                  <InfoBox
                    ...
                    value={driver?.licenses?.[0]?.license_number}
                  />
                  <InfoBox
                    label="Issue Date"
                    value={
                      driver?.licenses?.[0]?.issue_date
                        ? new Date(
                            driver?.licenses?.[0]?.issue_date
                          ).toLocaleDateString()
                        : ""
                ...
                <Row>
                  ...
                  <InfoBox
                    label="Eyes Color"
                    value={driver?.licenses?.[0]?.eye_color}
                  />
                ...
                <Row>
                  <InfoBox
                    label="height"
                    value={driver?.licenses?.[0]?.height}
                  />
                  <InfoBox
                    label="Province"
                    value={driver?.licenses?.[0]?.state}
                  />
                  <InfoBox
                    label="view"
                    value={driver?.licenses?.[0]?.license_image}
          ...
          <Form
            onSubmit={handleDriverLicenseUpload}
            className="mt-3 row g-3 align-items-center"
          >
          ...
          <Form
            onSubmit={handleDrugTestPDFUpload}
            className="mt-3 row g-3 align-items-center"
          >
            <input type="hidden" name="driver_id" value={driverId} />
            <Col md={8}>
  ...
  <Col className="mb-3">
    ...
    {label == "view" ? (
      <Button
        ...
        size="sm"
        onClick={() => handleDownloadLicense(value)}
      >
